...
# Will need input from partners when finishing the README

This is for a Movie Recommendation Sorter that efficiently identifies and rank top movie recommendations from a 100K movie rankings dataset using the following features:

- When the user types 1, a dataset (orginating from https://grouplens.org/datasets/movielens/100k/) will loaded and processed the MovieLens dataset
